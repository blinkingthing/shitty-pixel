//The overwhelming majority of this code was pulled from https://github.com/G42makes/ATTiny-i2c-RGB and modified for this SAO
...
#define I2C_SLAVE_ADDRESS 0x42 // the 7-bit address
...
#include <EEPROM.h>
#define EEPROM_REVISION 0x0002  //used to version the data so we can change the array below and have it override whats in EEPROM
...
{
  0x03,         // 0: Mode: 0=off, 1=solid, 2=fade, 3=rainbow loop
